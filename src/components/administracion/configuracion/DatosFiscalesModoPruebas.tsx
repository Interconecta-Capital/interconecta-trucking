...
import { FlaskConical, AlertTriangle, Info, CheckCircle2, XCircle } from 'lucide-react';
 ...
 * DEMOCRATIZADO: Visible para todos los usuarios para facilitar onboarding y testing
 */
