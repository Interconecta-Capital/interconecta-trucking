...
import { OpcionesEspecialesCorregido } from './OpcionesEspecialesCorregido';
...
interface ConfiguracionPrincipalMejoradaCorregidaProps {
  data: CartaPorteData;
...
export function ConfiguracionPrincipalMejoradaCorregida({ 
  data, 
  onChange, 
  onNext, 
  isFormValid 
}: ConfiguracionPrincipalMejoradaCorregidaProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <OpcionesEspecialesCorregido data={data} onChange={onChange} />
