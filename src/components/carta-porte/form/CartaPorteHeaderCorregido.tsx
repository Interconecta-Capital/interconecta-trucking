...
interface CartaPorteHeaderCorregidoProps {
...
export function CartaPorteHeaderCorregido({ 
  borradorCargado, 
  ultimoGuardado, 
  isSaving = false,
  onGuardarBorrador,
  ...
  onLimpiarBorrador,
  currentCartaPorteId
}: CartaPorteHeaderCorregidoProps) {
  ...
  const handleGuardarYSalir = async () => {
    ...
    try {
      ...
      // Navegación inmediata después de guardar
      setTimeout(() => {
