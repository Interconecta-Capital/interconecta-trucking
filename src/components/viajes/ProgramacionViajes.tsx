...
import { ProgramarViajeModal } from './modals/ProgramarViajeModal';
...
export function ProgramacionViajes() {
  ...
  const handleEditar = (viaje: any) => {
    console.log('Editando viaje:', viaje);
    // Aquí se implementaría la lógica para editar el viaje
  };

  const handleAsignarRecursos = (viaje: any) => {
    console.log('Asignando recursos a viaje:', viaje);
    // Aquí se implementaría la lógica para asignar recursos
  };
  ...
  return (
    <>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => handleAsignarRecursos(viaje)}
                        >
                          Asignar Recursos
                        </Button>
                      </div>
      ...
      <ProgramarViajeModal
        open={programarModal}
        onOpenChange={setProgramarModal}
      />
    </>
  );
}
