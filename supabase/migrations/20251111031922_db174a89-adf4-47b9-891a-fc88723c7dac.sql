-- Corrección FINAL de función anonimizar_usuario con nombres de columnas CORRECTOS
...
BEGIN
  ...
  -- 2. Anonimizar tabla usuarios (sin telefono)
  ...
  -- 3. Anonimizar conductores (COLUMNAS CORRECTAS)
  UPDATE public.conductores
  SET 
    nombre = anonimo_nombre,
    num_licencia = 'ANON' || substring(md5(random()::text) from 1 for 8),
    telefono = NULL,
    email = anonimo_email,
    direccion = NULL,
    rfc = 'ANONIMIZADO',
  ...
  -- 4. Anonimizar socios (COLUMNAS CORRECTAS)
  UPDATE public.socios
  SET 
    nombre_razon_social = anonimo_nombre,
    rfc = 'ANONIMIZADO',
    email = anonimo_email,
    telefono = NULL,
    direccion = NULL,
