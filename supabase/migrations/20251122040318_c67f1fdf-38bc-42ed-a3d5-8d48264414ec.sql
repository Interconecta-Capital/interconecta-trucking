-- ============================================
-- FUNCIÓN RPC: get_viaje_con_relaciones
-- ============================================
-- Obtiene un viaje con todos sus datos relacionados (conductor, vehículo, remolque, factura, carta porte, etc.)
-- Para mostrar información completa sin múltiples queries

CREATE OR REPLACE FUNCTION get_viaje_con_relaciones(p_viaje_id UUID)
RETURNS JSON AS $$
DECLARE
  v_result JSON;
BEGIN
...
COMMENT ON FUNCTION get_viaje_con_relaciones(UUID) IS 'Obtiene un viaje con todos sus datos relacionados (conductor, vehículo, remolque, factura, carta porte, etc.) en un solo query optimizado';