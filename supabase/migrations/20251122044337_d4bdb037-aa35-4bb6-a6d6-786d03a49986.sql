-- ============================================
-- CORRECCIÓN FINAL: Función RPC con columnas REALES
-- ============================================
...
BEGIN
  SELECT json_build_object(
    ...
    -- ✅ CORREGIDO: Usar columnas reales de vehiculos
    'vehiculo', CASE
    ...
    -- ✅ CORREGIDO: Usar columnas reales de remolques (sin numero_serie)
    'remolque', CASE
...
COMMENT ON FUNCTION public.get_viaje_con_relaciones(uuid) IS 'Obtiene un viaje completo con todas sus relaciones usando columnas reales de las tablas';